...
public class FBOExample {
	...
	public void initGL() {
		...
		GLU.gluPerspective (45.0f, 640f/480f, 1.0f, 100.0f);        // Calculate The Aspect Ratio Of The Window
	...
	public void renderGL() {
		...
		glViewport (0, 0, 128, 128);                                    // set The Current Viewport to the fbo size
		...
		glViewport (0, 0, 640, 480);                                    // set The Current Viewport
