...
public class Lesson10 {
    ...
    private void mainloop() {
        ...
        if (Keyboard.isKeyDown(Keyboard.KEY_UP)) {
            ...
            xpos -= (float) Math.sin(heading * piover180) * 0.0005f;
            zpos -= (float) Math.cos(heading * piover180) * 0.0005f;
            ...
            walkbias = (float) Math.sin(walkbiasangle * piover180) / 40.0f;
        }
    ...
    private Texture loadTexture(String path) {
		...
		try
		{
			ret = TextureLoader.getTexture("BMP", ResourceLoader.getResourceAsStream(path),true, GL_LINEAR);
    ...
    private final void setupWorld() {
        ...
        try {
            String line;
            BufferedReader dis = new BufferedReader(new FileReader("World.txt"));
